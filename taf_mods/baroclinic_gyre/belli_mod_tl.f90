...
integer, private :: mpi_belli_ray2d = mpi_datatype_null
integer, private :: mpi_belli_ray2d_tl = mpi_datatype_null
...
!==============================================
  ...
  if (mpi_belli_ray2d == mpi_datatype_null) then
...
!----------------------------------------------
  if (mpi_belli_ray2d_tl == mpi_datatype_null .or. &
      mpi_belli_ray2d == mpi_datatype_null ) then
    call ray2dpttypeinit_tl( ray2d(1),ray2d_tl(1),ray2d(2),ray2d_tl(2) )
  endif
  call mpi_bcast( beam%nsteps,1,mpi_integer,root,comm,ierr )
  call mpi_bcast( ray2d_tl,nmax,mpi_belli_ray2d_tl,root,comm,ierr )
  call mpi_bcast( ray2d,nmax,mpi_belli_ray2d,root,comm,ierr )
...
!==============================================
  ...
  if (ray2d_type_committed_tl) then
    call mpi_type_free( mpi_belli_ray2d_tl,ierr )
    mpi_belli_ray2d_tl = mpi_datatype_null
    ray2d_type_committed_tl =  .false. 
  endif
  end subroutine free_belli_ray2d
...
!==============================================
  ...
  if ( .not. ray2d_type_committed) then
    ...
    extent = a2-base
    call mpi_type_create_resized( tmptype,0_mpi_address_kind,extent,mpi_belli_ray2d,ierr )
...
!----------------------------------------------
  ...
  if ( .not. ray2d_type_committed_tl) then
    ...
    extent = a2-base
    call mpi_type_create_resized( tmptype,0_mpi_address_kind,extent,mpi_belli_ray2d_tl,ierr )
    call mpi_type_commit( mpi_belli_ray2d_tl,ierr )
    call mpi_type_free( tmptype,ierr )
